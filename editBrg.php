...
<body>
    <div class="container">
        ...
        <form action="" method='post' enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="hrg" class="form-label">Jenis</label>
                <input type="text" class="form-control" id="jenis" name="jenis" value="<?= $hrg; ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="jml" class="form-label">Stok</label>
                <input type="number" class="form-control" id="stok" name="stok" value="<?= $jml; ?>">
            </div>
            <div class=" mb-3">
...
$sql = "UPDATE brg SET nama='$nama', jenis='$jenis', hrg='$hrg', stok='$stok', keterangan='$keterangan', foto='$foto' WHERE id='$id'";
